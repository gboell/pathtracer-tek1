...
void			put_pix(t_cod *cor, t_mlx *init, double *color, int pass)
{
  ...
  if (cor->frames_left == init->frame_per_pixel)
    {
      color[0] = cor->col_final[0] / init->frame_per_pixel;
      color[1] = cor->col_final[1] / init->frame_per_pixel;
      color[2] = cor->col_final[2] / init->frame_per_pixel;
